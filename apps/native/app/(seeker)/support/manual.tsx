...
import { SupportManualInline } from "@/src/components/support/manual-inline";

const MANUAL_ASSET = require("../../../../../docs/manual/seeker-manual.md");
...
export default function SeekerManualScreen() {
	...
	return (
		<BambiScreen scrollViewRef={scroll}>
			<BambiHeader
				description="저장소의 최신 구직자 이용 가이드 원문을 앱에서 확인합니다."
				title="구직자 이용 가이드"
			/>
			{body}
		</BambiScreen>
