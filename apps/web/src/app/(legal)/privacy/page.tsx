	...
	return (
		...
		>
			...
			<LegalSection heading="3. 개인정보의 보유 및 이용기간">
				...
				<LegalParagraph>
					다만 이용약관에 따라 이용이 제한된 회원의 부정 재가입과 탈퇴 계정의
					재로그인을 막기 위하여, 아이디·이메일 주소·비밀번호 등 인증정보,
					휴대폰번호, 성별, 생년월일과 본인확인 식별값(연계정보(CI)·중복가입확인
					정보(DI)의 일방향 암호화 값)은 탈퇴일로부터 <PrivacyRetentionDays />일
					동안 보관한 뒤 파기합니다. 이 값은 재가입·재로그인 차단 목적 외에는
					이용하지 않습니다. 보관 기간은 회사의 정책에 따라 변경될 수 있으며,
					변경 시 이 처리방침과 회원 탈퇴 화면에 표시되는 기간이 함께
					갱신됩니다.
				</LegalParagraph>
				<LegalParagraph>
