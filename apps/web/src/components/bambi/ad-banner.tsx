...
// 레일 슬롯 비율 — 공고 카드(VisualJobCard) 높이 122px을 aside 폭 259px에서 만드는 비율이다.
// 내역: border 2 + p-2 16 + 썸네일 행 60.25 + gap-2 8 + 급여 행 h-9 36 = 122.25px.
// 썸네일 행 높이를 정하는 건 h-14(56px) 썸네일이 아니라 그 옆 텍스트 열이다 —
