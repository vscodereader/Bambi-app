...
현재 `develop` 브랜치는 `origin/develop`보다 18커밋 앞서 있다.
...
- [조직/팀 관리 화면 고도화](./superpowers/plans/2026-06-23-bambi-organization-team-management.md)
- [운영자 bulk action의 API 일괄 처리 고도화](./superpowers/plans/2026-06-23-bambi-moderator-bulk-actions.md)
- [모바일 네이티브 앱 화면](./superpowers/plans/2026-06-23-bambi-native-app.md)
