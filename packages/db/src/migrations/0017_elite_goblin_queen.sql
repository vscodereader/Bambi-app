...
ALTER TYPE "public"."moderation_target_type" ADD VALUE 'support_inquiry';--> statement-breakpoint
ALTER TYPE "public"."moderation_target_type" ADD VALUE 'support_inquiry_message';--> statement-breakpoint
