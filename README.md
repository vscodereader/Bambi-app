...
- [신규 PR #379~#385 — 기능·검증·보류 조건](portfolio/LATEST-PRS.md)
...
문서 기본 화면은 `portfolio` 브랜치이며 원래 `mobile` 및 다른 브랜치는 별도로 보존함. Bambi 웹은 `develop`, 앱은 `mobile`과 진행 중 기능 브랜치를 함께 확인해야 함.
